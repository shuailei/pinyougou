							...
							<#list specificationItems as spec>
                                <dl>
									...
									<#list spec.attributeValue as attr>
 										<dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${attr}')?'selected':''}}" ng-click="selectSpecification('${spec.attributeName}','${attr}')">${attr}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
                                </dl>
							</#list>
