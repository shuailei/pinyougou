...
public class SmsUtils {
    ...
    static final String accessKeyId = "LTAIgIpkpHuc2WUQ";
    static final String accessKeySecret = "EUBEGm7Ylkl92D4vXD53s17KDA8vdy";
    ...
    public Map sendSms(String phone, String code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("万通矿业");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_154951116");
